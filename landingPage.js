  ...
  <div class="filterButton">
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        <p id="landSeeAll">See All</p>
        <p id="landSeeFilm">See Film</p>
        <p id="landSeeDigital">See Digital</p>
        <p id="landSeeBW">See B&W</p>
        <p id="landSeeColor">See Color</p>
        <p id="landSeePets">See Furry Friends</p>
